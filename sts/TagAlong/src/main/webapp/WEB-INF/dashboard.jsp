          ...
          <body class="dashboard bg-secondary">
		   ...
		   ">
            ...
            <div class="container text-center">
              ...
              <p class="text-danger">
                <c:out value="${useredit}"></c:out>
              </p>
              <p class="text-danger">
                <c:out value="${userdelete}"></c:out>
              </p>
                ...
                <c:forEach var="trip" items="${trips }">
                  ...
                  <div class="trip-card-content">
                    <div class="trip-card m-3 p-3 border border-dark rounded bg-info">
                      <h4> <a href="/trip/${trip.id}" class=link-light>
                          <c:out value="${trip.name}"></c:out>
                        </a></h4>
                      <h4>
                        <c:out value="${trip.location}"></c:out>
                      </h4>
                      <p>Start Date:
                        <fmt:formatDate pattern="MM/dd/yyyy" value="${trip.startDate}" />
                      </p>
                      <p>End Date: <c:if test="${trip.endDate == null}">
                          TBD
                        </c:if>
                        <fmt:formatDate pattern="MM/dd/yyyy" value="${trip.endDate}" />
                      </p>
                      <p>Traveller: <c:out value="${trip.user.name}"></c:out>
                      </p>
